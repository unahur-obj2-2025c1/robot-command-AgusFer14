...
public class RobotBuilder {
    ...
    public RobotBuilder encenderLuz(Habitacion habitacion) {
        tareasAEjecutar.add(new EncenderLuz(habitacion));
        return this;
    }

    public RobotBuilder apagarLuz(Habitacion habitacion) {
        tareasAEjecutar.add(new ApagarLuz(habitacion));
        return this;
    }

    public RobotBuilder limpiar(Habitacion habitacion) {
